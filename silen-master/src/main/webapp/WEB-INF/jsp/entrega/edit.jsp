    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            <div id="content-container">
                ...
                <div id="page-title">
                    <h1 class="page-header text-overflow">Edição de entrega</h1>
                </div>
                ...
                <div id="page-content">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <c:if test="${empty showEntregaNotFound}">
                                <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-1">
                                                    ...
                                                    <input class="form-control" name="id" value="${entrega.id}" readonly>
                                                </div>

                                                <div class="col-md-3">
                                                    <label class="control-label">Cliente:</label>
                                                    <select class="form-control" name="entrega.cliente.id">
                                                        <c:forEach items="${clientes}" var="cliente">
                                                            <option value="${cliente.id}" ${cliente.id == entrega.cliente.id ? 'selected="selected"' : ''}>${cliente.nome}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" value="${entrega.motoboy.nome}" readonly>
                                                </div>

                                                <div class="col-md-3">
                                                    <label class="control-label">Caixa:</label>
                                                    <select class="form-control" name="entrega.caixa.id">
                                                        <c:forEach items="${caixas}" var="caixa">
                                                            <option value="${caixa.id}" ${caixa.id == entrega.caixa.id ? 'selected="selected"' : ''}>${caixa.nome}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>

	...
	<div id="container" class="effect aside-float aside-bright mainnav-lg">
		...
		<div class="boxed">
			<div id="content-container">
			    ...
			    <div id="page-title">
			        <h1 class="page-header text-overflow">Motoboys</h1>
			    </div>
					                    ...
					                    <table class="table toggle-circle tablet breakpoint no-paging footable-loaded footable">
					                        <thead>
					                           <tr>
					                                ...
					                                <th class="footable-visible footable-first-column footable-sortable"><font><font>Usuário</font></font></th>
					                            </tr>
					                        </thead>
					                        <tbody>
						                        <c:forEach items="${motoboys}" var="motoboy">
													<tr>
														<td class="text-left">
															<a href="/motoboy/${motoboy.id}" class="btn btn-hover-warning ti-pencil-alt add-tooltip"></a>
															<a href="/motoboy/${motoboy.id}/excluir" class="btn btn-hover-danger ti-trash add-tooltip"></a>
														</td>
														<td>${motoboy.id}</td>
														<td>${motoboy.nome}</td>
														<td>${motoboy.user.username}</td>
													</tr>
												</c:forEach>
					                        </tbody>
					                    </table>

					                    <a href="/motoboy" class="btn btn-info pull-right">Cadastrar novo motoboy</a>
					                </div>
								</div>
					        </div>
					    </div>
